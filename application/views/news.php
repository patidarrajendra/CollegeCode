<div class="content container">  
    <div class="page-wrapper">
        <header class="page-heading clearfix">
            <h1 class="heading-title pull-left">News Listing</h1> 
                ...
                <div class="news-wrapper col-md-12 col-sm-7">                         
                    <article class="news-item page-row has-divider clearfix row">       
                        <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                            <img class="img-responsive" src="<?php echo base_url();?>assets/images/news/news-thumb-1.jpg" alt="" />
                        </figure>
                        <div class="details col-md-10 col-sm-9 col-xs-8">
                            ...
                            <a class="btn btn-theme read-more" href="<?php echo base_url();?>front/news-detail">Read more<i class="fa fa-chevron-right"></i></a>
                        </div>
                    </article><!--//news-item-->
                    <article class="news-item page-row has-divider clearfix row">       
                        <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                            <img class="img-responsive" src="<?php echo base_url();?>assets/images/news/news-thumb-2.jpg" alt="" />
                        </figure>
                        <div class="details col-md-10 col-sm-9 col-xs-8">
                            <h3 class="title"><a href="<?php echo base_url();?>front/news-detail">Aenean eleifend ornare nisi id molestie</a></h3>
                    ...
                    <article class="news-item page-row has-divider clearfix row">       
                        <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                            <img class="img-responsive" src="<?php echo base_url();?>assets/images/news/news-thumb-3.jpg" alt="" />
                        </figure>
                        <div class="details col-md-10 col-sm-9 col-xs-8">
                            <h3 class="title"><a href="<?php echo base_url();?>front/news-detail">Quisque venenatis consequat commodo</a></h3>
                    ...
                    <article class="news-item page-row has-divider clearfix row">       
                        <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                            <img class="img-responsive" src="<?php echo base_url();?>assets/images/news/news-thumb-4.jpg" alt="" />
                        </figure>
                        <div class="details col-md-10 col-sm-9 col-xs-8">
                            <h3 class="title"><a href="<?php echo base_url();?>front/news-detail">Donec feugiat enim sit amet nisl scelerisque</a></h3>
                    ...
                    <article class="news-item page-row has-divider clearfix row">       
                        <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                            <img class="img-responsive" src="<?php echo base_url();?>assets/images/news/news-thumb-5.jpg" alt="" />
                        </figure>
                        <div class="details col-md-10 col-sm-9 col-xs-8">
                            <h3 class="title"><a href="<?php echo base_url();?>front/news-detail">Ut eleifend dapibus ligula a ornare</a></h3>
                    ...
                    <article class="news-item page-row has-divider clearfix row">       
                        <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                            <img class="img-responsive" src="<?php echo base_url();?>assets/images/news/news-thumb-6.jpg" alt="" />
                        </figure>
                        <div class="details col-md-10 col-sm-9 col-xs-8">
                            <h3 class="title"><a href="<?php echo base_url();?>front/news-detail">Pellentesque sollicitudin leo non lacinia mattis</a></h3>
                            <p>Morbi bibendum consectetuer, vulputate, sollicitudin, primis ullamcorper vulputate sed risus dis feugiat vel gravida, class enim Mus aliquam ut donec sodales bibendum rutrum dis sit rutrum id eleifend. Dapibus potenti.</p>
                            <a class="btn btn-theme read-more" href="<?php echo base_url();?>front/news-detail">Read more<i class="fa fa-chevron-right"></i></a>
                        </div>
                    </article>
