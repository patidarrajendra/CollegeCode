    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <div class="col-lg-4 col-md-2 col-sm-6 col-xs-12">
                <a href="<?php echo base_url();?>uploads/product_excel/demo_product_import_excel.xlsx" download><button class="btn btn-primary waves-effect button_postion1" type="button">Demo Excel</button></a>&nbsp;
