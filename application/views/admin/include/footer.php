...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>  
    ...
    <script src="<?php echo base_url(); ?>assets/js/admin/pages/tables/jquery-datatable.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/js/admin/pages/forms/advanced-form-elements.js"></script>
    ...
    <script type="text/javascript">
     ...
     //  $('#state_id').load('<?php echo base_url();?>College/state'+state);
     // }
    </script>
</body>
</html>