<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	function sendPushNotification($data, $reg_id) 
	{
	     ...
	     $apiKey = "AIzaSyD2mM0wpzk6ndKuwH4CS0qmJbL0Z1s2GGQ";
	     $post = array(
	                     //'to'  => $reg_id,
	...
	function send_android_notification($data, $reg_id) {
	$fields = array(
	'reg_id' => array($reg_id),
	'data'=> $data,
	);
	$headers = array(
	'Authorization: key=AIzaSyD2mM0wpzk6ndKuwH4CS0qmJbL0Z1s2GGQ', // FIREBASE_API_KEY_FOR_ANDROID_NOTIFICATION
	'Content-Type: application/json'
	);
	// Open connection
	$ch = curl_init();
